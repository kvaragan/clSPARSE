...
template<typename VALUE_TYPE, typename INDEX_TYPE>
void csrmv(size_t n_rows, size_t n_cols, size_t nnz,
...
//simple spmv for csr matrix to obtain reference results;
template<typename VALUE_TYPE, typename INDEX_TYPE>
void csrmm(size_t n_rows, size_t n_cols, size_t nnz,
            const std::vector<INDEX_TYPE>& row_offsets,
            const std::vector<INDEX_TYPE>& col_indices,
            const std::vector<VALUE_TYPE>& values,
...
//simple spmv for csr matrix to obtain reference results;
template<typename VALUE_TYPE, typename INDEX_TYPE>
void coomv(size_t n_rows, size_t n_cols, size_t nnz,
...
template<typename VALUE_TYPE, typename INDEX_TYPE>
void csr_transpose(size_t n_rows, size_t n_cols, size_t nnz,
                   const std::vector<INDEX_TYPE>& row_offsets,
                   const std::vector<INDEX_TYPE>& col_indices,
                   const std::vector<VALUE_TYPE>& values,
...
//simple spmv for csr matrix to obtain reference results;
template<typename VALUE_TYPE, typename INDEX_TYPE>
void csr2dense(size_t n_rows, size_t n_cols, size_t nnz,
               const std::vector<INDEX_TYPE>& row_offsets,
               const std::vector<INDEX_TYPE>& col_indices,
               const std::vector<VALUE_TYPE>& values,
...
//simple spmv for csr matrix to obtain reference results;
template<typename VALUE_TYPE, typename INDEX_TYPE>
void csr2coo(size_t n_rows, size_t n_cols, size_t nnz,
